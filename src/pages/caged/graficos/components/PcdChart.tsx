...
import { deficienciaChartConfig } from "@/pages/caged/graficos/components/chartConfigData";
import { transformDeficienciaData } from "@/pages/caged/graficos/components/transformToChartData";
