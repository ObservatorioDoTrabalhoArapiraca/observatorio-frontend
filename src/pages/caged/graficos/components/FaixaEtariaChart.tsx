...
import { faixaEtariaChartConfig } from "@/pages/caged/graficos/components/chartConfigData";
import { transformFaixaEtariaData } from "@/pages/caged/graficos/components/transformToChartData";
