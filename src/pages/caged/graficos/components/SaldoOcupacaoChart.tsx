...
import { transformSaldoOcupacaoData } from "@/pages/caged/graficos/components/transformToChartData";
...
export default function SaldoOcupacaoChart() {
  ...
  const chartData = transformSaldoOcupacaoData(dados, isAnual, topN);
